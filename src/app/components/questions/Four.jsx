                ...
                >
                  ...
                  <button
                    onClick={() => {
                      ...
                      props.answerFormHandler.setValue("employeeId", item._id);
                      props.answerFormHandler.setValue(
                        "userId",
                        session.user.email
                      );
                      props.answerFormHandler.setValue("question1.answer", "");
                      props.answerFormHandler.setValue("question2.answer", "");
                      props.answerFormHandler.setValue("question3.answer", "");
                    }}
